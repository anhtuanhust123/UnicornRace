...
public class TrainingOverviewAdapter extends RecyclerView.Adapter<TrainingOverviewAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public TrainingOverviewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
                                                                 int viewType) {
        View v;
        ViewHolder vh = null;
        switch (viewType) {
        ...
        switch (getItemViewType(position)) {
            case VIEW_TYPE_SUMMARY:
                ...
                if (trainingSummaryViewHolder.mTextViewSince != null) {
                    SimpleDateFormat df = new SimpleDateFormat("MMMM yyyy", trainingSummaryViewHolder.itemView.getResources().getConfiguration().locale);
            ...
            case VIEW_TYPE_TRAINING_SESSION:
                ...
                if (trainingSessionViewHolder.mRatingBarFeeling != null) {
                    ...
                    trainingSessionViewHolder.view.setOnClickListener(v -> {
    ...
    public static class MonthHeadlineViewHolder extends ViewHolder {
        public TextView mTextViewName;
    ...
    public static class TrainingSummaryViewHolder extends ViewHolder {
        public TextView mTextViewSteps;
        public TextView mTextViewDistance;
        public TextView mTextViewCalories;
        public TextView mTextViewDuration;
        ...
        public TrainingSummaryViewHolder(View v) {
            ...
            mTextViewCaloriesTitle = v.findViewById(R.id.calorieTitle);
