...
public class StepCountPersistenceHelper {
     ...
     */
    public static final String BROADCAST_ACTION_STEPS_SAVED = "com.example.unicornracestepcounter.STEPS_SAVED";
    public static final String BROADCAST_ACTION_STEPS_UPDATED = "com.example.unicornracestepcounter.STEPS_UPDATED";
    public static final String BROADCAST_ACTION_STEPS_INSERTED = "com.example.unicornracestepcounter.STEPS_INSERTED";
