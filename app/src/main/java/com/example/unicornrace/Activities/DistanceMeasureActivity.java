...
public class DistanceMeasureActivity extends AppCompatActivity implements View.OnClickListener {

    public static final String LOG_CLASS = DistanceMeasureActivity.class.getName();
    private final DistanceMeasureActivity.BroadcastReceiver broadcastReceiver = new DistanceMeasureActivity.BroadcastReceiver();
