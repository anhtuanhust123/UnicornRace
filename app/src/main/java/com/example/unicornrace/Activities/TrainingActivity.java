...
public class TrainingActivity extends AppCompatActivity {
    ...
    public static final String BROADCAST_ACTION_TRAINING_STOPPED = "com.example.unicornracestepcounter.TRAINING_STOPPED";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewCaloriesTitle = findViewById(R.id.training_calories_title);
    ...
    protected void updateView() {
        ...
        mTextViewVelocity.setText(String.format(getResources().getConfiguration().locale, "%.2f", UnitHelper.kilometersPerHourToUsersVelocityUnit(UnitHelper.metersPerSecondToKilometersPerHour(this.training.getVelocity()), this)));
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.training_stop_button) {
            stopTraining();
        }
    }
