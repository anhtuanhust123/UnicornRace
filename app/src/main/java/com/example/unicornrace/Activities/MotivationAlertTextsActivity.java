...
import com.example.unicornrace.Adapter.MotivationAlertTextsAdapter;
...
public class MotivationAlertTextsActivity extends AppCompatActivity implements MotivationAlertTextsAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAddMotivationTextButton.setOnClickListener(v -> showEditDialog(null));

        // init recycler view
        // specify the adapter
        mAdapter = new MotivationAlertTextsAdapter(new ArrayList<>());
    ...
    protected void showMotivationAlertTexts() {
        ...
        motivationTexts = new ArrayList<>(Arrays.asList(stringSet.toArray(new String[0])));
