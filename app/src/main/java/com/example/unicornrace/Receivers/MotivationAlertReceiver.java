...
public class MotivationAlertReceiver extends GCoreWakefulBroadcastReceiver {
    ...
    private void motivate() {
        ...
        // Notify
        Objects.requireNonNull(notificationManager).notify(NOTIFICATION_ID, mBuilder.build());
